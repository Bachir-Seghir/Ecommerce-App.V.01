...
})(["position:relative;.count{display:block;position:relative;transition:all 0.4s;backface-visibility:hidden;}.count-enter{transform:rotateX(0.5turn);}.ciunt-enter-active{transform:rotateX(0);}.count-exit{top:0;position:absolute;transform:rotateX(0.5turn);}.ciunt-exit-active{transform:rotateX(0);}"]);
...
//# sourceMappingURL=_app.js.c68928a7ca4068e0d35a.hot-update.js.map